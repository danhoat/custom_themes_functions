 <?php
    global $profile, $user_ID, $current_user, $profile_id;
    ...
    if (fre_share_role() || $user_role == FREELANCER) {
        $is_fre = 1;
    } else if (!fre_share_role() && $user_role != FREELANCER) {
        $is_emp = 1;
    }
     ...
     <div class="profile-<?php echo $role_template; ?>-info-wrap active">
         ...
         <div class="profile-freelance-info cnt-profile-hide" id="cnt-profile-default" style="display: block">
             ...
             <div class="<?php echo $role_template; ?>-info-content">
                 <div class="freelance-rating">
                     ...
                     <?php
                        // freelancer info: number of exp years & number of projects worked
                        if (fre_share_role() || ae_user_role($user_ID) == FREELANCER) { ?>
                     ...
                     <?php }
                        ...
                        // employer info: projects posted & number of freelancers hired
                        else { ?>
                 ...
                 <?php
                    // insert block hourly & skill info of freelancer
                    if (fre_share_role() || ae_user_role($user_ID) == FREELANCER) { ?>
             ...
             <div class="employer-info-edit">
                 <a href="javascript:void(0)" class="fre-normal-btn-o employer-info-edit-btn profile-show-edit-tab-btn" data-ctn_edit="ctn-edit-profile"><?php _e('Edit', ET_DOMAIN) ?></a>
             </div>
         ...
         <div class="profile-employer-info-edit cnt-profile-hide" id="ctn-edit-profile" style="display: none">
             ...
             <div class="fre-employer-info-form" id="accordion" role="tablist" aria-multiselectable="true">
                 <form id="profile_form" class="form-detail-profile-page" action="#" autocomplete="off" method="post" novalidate autocomplete="off">
                     <div class="fre-input-field">
                         <input type="text" value="<?php echo $display_name ?>" name="display_name" id="display_name" placeholder="<?php _e('Your name', ET_DOMAIN) ?>" autocomplete="off">
                     </div>

                     <?php if (fre_share_role() || $user_role == FREELANCER) { ?>
                         <div class="fre-input-field">
                             <input type="text" name="et_professional_title" <?php if ($job_title) {
                                                                                    echo 'value= "' . esc_attr($job_title) . '" ';
                                                                                } ?> placeholder="<?php _e("Professional Title", ET_DOMAIN) ?>" autocomplete="off">
                         </div>
                     <?php } ?>
                     ...
                     <div class="fre-input-field">
                        ...
                        $com_fields = get_user_meta($user_ID, 'company_fieds', true);
                        ...
                        if( isset($com_fields['country']) )
                        $country_arr[] = $com_fields['country'];
                    ...
                    <?php
                    $company_city       = isset($com_fields['company_city']) ? $com_fields['company_city'] :'';
                    $company_state      = isset($com_fields['company_state']) ? $com_fields['company_state'] :'';
                    $company_address    = isset($com_fields['company_address']) ? $com_fields['company_address'] :'';
                    $zipcode            = isset($com_fields['zipcode']) ? $com_fields['zipcode'] :'';

                    $bus_reg_number            = isset($com_fields['bus_reg_number']) ? $com_fields['bus_reg_number'] :'';
                    $vat_number            = isset($com_fields['vat_number']) ? $com_fields['vat_number'] :'';
                    $eu_vat_number            = isset($com_fields['eu_vat_number']) ? $com_fields['eu_vat_number'] :'';
                    $class_css = 'fre-two-fields';
                    if ( fre_share_role() || $user_role == FREELANCER ) $class_css = 'fre-three-fields';
                    ?>
                   
                    <div class="fre-custom-fields  ">
                        <div class="col">
                            <input type="text" name="company_address" id="company_address" placeholder="<?php _e('Address ', ET_DOMAIN);?>"  value="<?php echo esc_attr($company_address);?>">
                        </div>
                    </div>

                    <div class="fre-custom-fields fre-three-fields">
                        <div class="col">
                            <input type="text" name="company_city" id="company_city" placeholder="<?php _e('City', ET_DOMAIN);?>" value="<?php echo esc_attr($company_city);?>" >
                        </div>
                        <div class="col">
                            <input type="text" name="company_state" id="company_state" placeholder="<?php _e('State', ET_DOMAIN);?>" value="<?php echo esc_attr($company_state);?>">
                        </div>
                        <div class="col">
                            <input type="text" name="zipcode" id="zipcode" placeholder="<?php _e('ZIP code', ET_DOMAIN);?>" value="<?php echo esc_attr($zipcode);?>">
                        </div>
                    </div>

                    <div class="fre-custom-fields <?php echo $class_css;?> fre-field-has-tooltip">
                        <div class="col">
                            <input type="text" name="bus_reg_number" id="bus_reg_number" placeholder="<?php _e('Business Registration Number ', ET_DOMAIN);?>" value="<?php echo esc_attr($bus_reg_number);?>">
                        </div>
                        <div class="col">
                            <input type="text" name="vat_number" id="vat_number" placeholder="<?php _e('VAT number', ET_DOMAIN);?>" value="<?php echo esc_attr($vat_number);?>">
                        </div>
                        <?php  if ( fre_share_role() || $user_role == FREELANCER ) { ?>
                            <div class="col">
                                <input type="text" name="eu_vat_number" id="eu_vat_number" placeholder="<?php _e('EU VAT Number', ET_DOMAIN);?>" value="<?php echo esc_attr($eu_vat_number);?>">
                            </div>
                        <?php } ?>
                    </div>
                    ...
                    <?php } ?>
                     ...
                     <?php if (fre_share_role() || $user_role == FREELANCER) { ?>
                         <div class="fre-input-field fre-experience-field">
                             <input type="number" value="<?php echo $experience; ?>" name="et_experience" id="et_experience" min="0" placeholder="<?php _e('Total', ET_DOMAIN) ?>">
                         ...
                         <!-- <div class="fre-input-field fre-hourly-field">
                             <input type="number" <?php if ($hour_rate) {
                                                    ...
                                                    } ?> name="hour_rate" id="hour_rate" step="5" min="0" placeholder="<?php _e('Hour rate', ET_DOMAIN) ?>">
                             <span>
                         ...
                         <div class="fre-input-field">
                             ...
                             <label class="fre-checkbox no-margin-bottom" for="email-skill">
                                 <input id="email-skill" type="checkbox" name="email_skill" value="1" <?php checked($email_skill, 1); ?>>
                                 <span></span>
                                 <?php _e('Email me jobs that are relevant to my skills & country', ET_DOMAIN) ?>
                             </label>
                         </div>
         ...
         <div class="profile-freelance-available">
             ...
             <div class="fre-input-field">
                 <label for="fre-switch-user-available" class="fre-switch">
                     <input id="fre-switch-user-available" type="checkbox" <?php echo $user_available ? 'checked' : ''; ?>>
         ...
         <div class="profile-employer-secure cnt-profile-hide" id="cnt-account-default" style="display: block">
             ...
             <?php
                if (!empty($user_meta['newemail'])) {
                    printf(
                        __('<p class="noti-update">There is a pending change of the email to %1$s. <!--<a href="%2$s">Cancel</a>--></p>', ET_DOMAIN),
             ...
             <div class="employer-secure-edit">
                 <a href="javascript:void(0)" class="fre-normal-btn-o profile-show-edit-tab-btn" data-ctn_edit="ctn-edit-account"><?php _e('Edit', ET_DOMAIN) ?></a>
             </div>
         </div>
         ...
         <div class="profile-employer-secure-edit cnt-profile-hide" id="ctn-edit-account" style="display: none">
             <form id="account_form" novalidate>
                ...
                <div class="fre-input-field">
                     ...
                     <input type="text" class="" id="phone" name="phone" value="<?php echo $phone ?>" placeholder="<?php _e('Phone Number', ET_DOMAIN) ?>">
                </div>
                 ...
                 <div class="employer-info-save btn-update-profile">
                     <input type="submit" class="fre-normal-btn fre-btn" name="" style="width: 100%" value="<?php _e('Save', ET_DOMAIN) ?>">
                     <span class="employer-info-cancel-btn profile-show-edit-tab-btn" data-ctn_edit="cnt-account-default"><?php _e('Cancel', ET_DOMAIN) ?></span>
                 </div>
             </form>
         </div>
     </div>
