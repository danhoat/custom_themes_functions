						...
						<form role="form" id="signup_form">
							...
							<div class="fre-custom-fields fre-two-fields">
								...
								<?php if($role !== 'employer'){ ?> <!-- Freelancer fields !-->
									<div class="fre-custom-fields  fre-field-has-tooltip">
										<div class="col">
								...
								<?php } else { ?> <!-- Employer fields !-->
									<div class="fre-custom-fields fre-two-fields fre-field-has-tooltip">
										...
										<div class="col">
											<?php box_tooltips(__('VAT number', ET_DOMAIN)) ;?>
											<input type="text" name="vat_number" required id="vat_number" placeholder="<?php _e('VAT number', ET_DOMAIN);?>">
										</div>
									</div>
							<?php } ?>
...
<script type="text/javascript">
	jQuery( document ).ready(function() {
	    console.log( "ready!" );
	    // $(".fre-chosen-single").chosen().change(function(){
	    //     console.log('123');
	    // });
	});
